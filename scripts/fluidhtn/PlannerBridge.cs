...
public static partial class PlannerBridge
{
    ...
    public static string PlanBunkerGoal(string goalKey)
    {
        ...
        switch (goalKey)
        {
            ...
            case "bunkerBreached": ctx.GoalBunkerBreached = true; break;
            case "agentAt_bunker_interior": ctx.GoalAgentAt = BunkerWorld.Nodes.BunkerInterior; break;
            case "agentAt_c4_table": ctx.GoalAgentAt = BunkerWorld.Nodes.C4Table; break;
            case "agentAt_table_area": ctx.GoalAgentAt = BunkerWorld.Nodes.TableArea; break;
            case "hasC4": ctx.GoalHasC4 = true; break;
            case "agentAt_star": ctx.GoalAgentAt = BunkerWorld.Nodes.StarPos; break;
            case "hasKey": ctx.GoalHasKey = true; break;
            case "hasStar":
            default:
